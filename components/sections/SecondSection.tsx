        ...
        <div className="flex flex-col md:flex-row md:items-start gap-7 w-full">
          ...
          <div className="flex flex-col space-y-7 items-center md:items-start">
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#0b0e0d] to-[#202523] bg-[#0d0d0d] p-6 w-full sm:w-[350px] md:w-[400px] md:h-[300px]">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-2 text-base text-[#b1b1b1]">
                  Deposit your cryptocurrency securely as collateral. Your asset is never sold, it stays yours until you fully repay your loan.
                </p>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#0b0e0d] to-[#202523] bg-[#0d0d0d] p-6 w-full sm:w-[350px] md:w-[400px] md:h-[300px] h-[250px]">
              ...
              <div className="relative z-10">
                <h1 className="text-lg font-semibold text-white">Lock Your cryptocurrency</h1>
                <p className="mt-2 text-base text-[#b1b1b1]">
                  Lock your cryptocurrency securely as collateral. Your asset is never sold, it remains yours until you repay within your chosen timeframe. You can also adjust your repayment due date.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center md:block w-full md:w-auto">
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#0b0e0d] to-[#202523] bg-[#0d0d0d] p-6 w-full sm:w-[350px] md:w-[400px] md:h-[630px] h-[250px] mx-auto md:mx-0">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-2 text-base text-[#b1b1b1]">
                  Your assets are protected with industry-grade security and smart risk controls. asset used as collateral is never sold or rehypothecated without clear conditions. Transparent loan terms and automated safeguards help prevent unexpected losses. You stay in control of your assets at every stage.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-7 items-center md:items-start">
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#0b0e0d] to-[#202523] bg-[#0d0d0d] p-6 w-full sm:w-[350px] md:w-[400px] md:h-[300px] h-[250px]">
              ...
              <div className="relative z-10">
                <h1 className="text-lg font-semibold text-white">Get Stablecoin</h1>
                <p className="mt-2 text-base text-[#b1b1b1]">
                  Borrow USDT or USDC instantly based on the value of your locked asset and your selected loan amount. Funds are sent directly to your wallet, giving you fast access to stable liquidity without selling your assets.
                </p>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-[#0b0e0d] to-[#202523] bg-[#0d0d0d] p-6 w-full sm:w-[350px] md:w-[400px] h-[250px] md:h-[300px]">
              ...
              <div className="relative z-10">
                <h1 className="text-lg font-semibold text-white">Repay & Unlock</h1>
                <p className="mt-2 text-base text-[#b1b1b1]">
                  Pay back your loan when you're ready and unlock your asset immediately. No hidden steps repay and regain full access to your assets.
                </p>
              </div>
            </div>
          </div>
